...
export const classSchemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS class_students (
    ...
    start_image_limit INTEGER NOT NULL DEFAULT 5,
    start_image_used INTEGER NOT NULL DEFAULT 0,
    end_image_limit INTEGER NOT NULL DEFAULT 5,
    end_image_used INTEGER NOT NULL DEFAULT 0,
    status TEXT NOT NULL DEFAULT 'active',
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL,
